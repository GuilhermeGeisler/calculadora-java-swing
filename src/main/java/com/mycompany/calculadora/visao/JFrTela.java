...
import com.mycompany.calculadora.controle.CalculadoraService;
...
public class JFrTela extends javax.swing.JFrame {
    ...
    private void btMaisMenosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMaisMenosActionPerformed
        setTfValor(getTfValorAsDouble() * -1);
    ...
    private void btIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btIgualActionPerformed
        setTfValor(calculadora.calcularResultado(getTfValorAsDouble()));
    }//GEN-LAST:event_btIgualActionPerformed

    private void processaOperacao(EnumOperacao operacao) {
        try {
            // Realiza a operação com o total acumulado e valor atual
            calculadora.realizaOperacao(operacao, getTfValorAsDouble());
            limpa();
    ...
    private String doubleToString(Double numero) {
        ...
        return getDecimalFormat().format(numero);
    }

    private Double getTfValorAsDouble() {
        return stringToDouble(tfValor.getText());
    }

    private Double stringToDouble(String numero) {
        try {
            return Double.valueOf(numero.replace(",", "."));
        } catch (NumberFormatException ex) {
            return 0.0;
        }
    }

    private void setTfValor(Double valor) {
    ...
    private void digita(String caractere) {
        if ("0".equals(tfValor.getText()) && !Objects.equals(caractere, ",")) {
            tfValor.setText(caractere);
        } else if (!caractere.equals(",") || !tfValor.getText().contains(",")) {
